...
//ACHTUNG: Standardmäßig ist temp mmode = 0,0,0  
//Das entspricht laguerre_00
...
double laser_intensity_profile_laguerre_00(double x, double y, double z)
{
  ...
  if( x >= laser_offset ){
    ...
    rho *= laser_sigma_w0;
    //MYMOD:
    rho*=2.0;  //dadurch ist I(w_0)=I0*1/e^2 bzw. F(w_0)=F0*1/e^2, wobei F=Fluenz
    //ENDOF MYMOD

//ACHTUNG: w0 ist eigentlich 1/w0^2, siehe in imd_laser.c:
