...
//MYMOD
#ifdef TTM
#define NUMNEIGHS(cell,i)       (atoms.numneighs [(cell)->ind[i]])
#endif
#ifdef LOD	//local order parameter
#define LODP(cell,i)       (atoms.lod [(cell)->ind[i]]
#endif
#ifdef NRB 	//Non-reflecting boundary cond:gives index of sub'th neigh of atom i
#define NRBI(cell,i,j)          (atoms.nrbid [(cell)->ind[i]])	//wird sowieso nicht genutzt, wenn VEC nicht defined!
//#define NRBTYPE(cell,i)		(atoms.nrbtype [(cell)->ind[i]])
#endif
//ENDOF MYMOD
